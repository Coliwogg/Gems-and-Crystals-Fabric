...
public class ModArmorMaterials {
    ...
    public static final ResourceKey<EquipmentAsset> RUBY_KEY = ResourceKey.create(REGISTRY_KEY, GemsAndCrystals.identifier("ruby"));
    public static final ResourceKey<EquipmentAsset> SAPPHIRE_KEY = ResourceKey.create(REGISTRY_KEY, GemsAndCrystals.identifier("sapphire"));
    public static final ResourceKey<EquipmentAsset> EMERALD_KEY = ResourceKey.create(REGISTRY_KEY, GemsAndCrystals.identifier("emerald"));
    public static final ResourceKey<EquipmentAsset> TOPAZ_KEY = ResourceKey.create(REGISTRY_KEY, GemsAndCrystals.identifier("topaz"));
    public static final ResourceKey<EquipmentAsset> AMETHYST_KEY = ResourceKey.create(REGISTRY_KEY, GemsAndCrystals.identifier("amethyst"));
    public static final ResourceKey<EquipmentAsset> QUARTZ_KEY = ResourceKey.create(REGISTRY_KEY, GemsAndCrystals.identifier("quartz"));
