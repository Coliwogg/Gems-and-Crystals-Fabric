...
public class ModTrimMaterials {
    public static final ResourceKey<TrimMaterial> RUBY = ResourceKey.create(Registries.TRIM_MATERIAL, Identifier.fromNamespaceAndPath(GemsAndCrystals.MOD_ID, "ruby"));
    public static final ResourceKey<TrimMaterial> SAPPHIRE = ResourceKey.create(Registries.TRIM_MATERIAL, Identifier.fromNamespaceAndPath(GemsAndCrystals.MOD_ID, "sapphire"));
    public static final ResourceKey<TrimMaterial> TOPAZ = ResourceKey.create(Registries.TRIM_MATERIAL, Identifier.fromNamespaceAndPath(GemsAndCrystals.MOD_ID, "topaz"));
