...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Function<BlockBehaviour.Properties, Block> function) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, GemsAndCrystals.identifier(name), toRegister);
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, GemsAndCrystals.identifier(name),
                new BlockItem(block, new Item.Properties().useBlockDescriptionPrefix()
                        .setId(ResourceKey.create(Registries.ITEM, GemsAndCrystals.identifier(name)))));
    }
