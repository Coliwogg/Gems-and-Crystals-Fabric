...
public class ModItems {
    ...
    public static final Item EMERALD_AXE = registerItem("emerald_axe", new AxeItem(ModToolMaterial.EMERALD, 5, -2.9f, new FabricItemSettings()));
    ...
    public static final Item TOPAZ_SHOVEL = registerItem("topaz_shovel", new ShovelItem(ModToolMaterial.TOPAZ, 1.5f, -3, new FabricItemSettings()));
    ...
    public static final Item TOPAZ_AXE = registerItem("topaz_axe", new AxeItem(ModToolMaterial.TOPAZ, 5, -3.03f, new FabricItemSettings()));
    public static final Item TOPAZ_HOE = registerItem("topaz_hoe", new HoeItem(ModToolMaterial.TOPAZ, -2, -0.5f, new FabricItemSettings()));
    public static final Item AMETHYST_SWORD = registerItem("amethyst_sword", new SwordItem(ModToolMaterial.AMETHYST, 3, -2.4f, new FabricItemSettings()));
    ...
    public static final Item AMETHYST_AXE = registerItem("amethyst_axe", new AxeItem(ModToolMaterial.AMETHYST, 5.5f, -3.07f, new FabricItemSettings()));
    public static final Item AMETHYST_HOE = registerItem("amethyst_hoe", new HoeItem(ModToolMaterial.AMETHYST, -1, 0, new FabricItemSettings()));
    ...
    public static final Item QUARTZ_SHOVEL = registerItem("quartz_shovel", new ShovelItem(ModToolMaterial.QUARTZ, 1.5f, -3, new FabricItemSettings()));
    ...
    public static final Item QUARTZ_AXE = registerItem("quartz_axe", new AxeItem(ModToolMaterial.QUARTZ, 5, -3.15f, new FabricItemSettings()));
    public static final Item QUARTZ_HOE = registerItem("quartz_hoe", new HoeItem(ModToolMaterial.QUARTZ, -1, -1, new FabricItemSettings()));
