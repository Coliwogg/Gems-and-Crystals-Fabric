...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.registerSpear(ModItems.RUBY_SPEAR);
        ...
        itemModelGenerator.registerSpear(ModItems.SAPPHIRE_SPEAR);
        ...
        itemModelGenerator.registerSpear(ModItems.EMERALD_SPEAR);
        ...
        itemModelGenerator.registerSpear(ModItems.TOPAZ_SPEAR);
        ...
        itemModelGenerator.registerSpear(ModItems.AMETHYST_SPEAR);
        ...
        itemModelGenerator.registerSpear(ModItems.QUARTZ_SPEAR);
